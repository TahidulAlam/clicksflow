...
//   { value: "cheackbox", label: "Cheack Box" },
...
//       defaultValues: defaultValues ?? { formLabel: "" },
//     });

//     useEffect(() => {
//       if (isOpen) {
//         reset(defaultValues ?? { formLabel: "" });
//       }
...
//       ? "Edit Event"
//       : "Add New Event";
//     const isRequiredSelection = watch("isRequired");
//     return (
//       <Modal
//         isOpen={isOpen}
