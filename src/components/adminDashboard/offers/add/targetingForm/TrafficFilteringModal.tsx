...
const TrafficFilteringModal: React.FC<TrafficFilteringModalProps> = ({
  ...
  const handleClose = () => {
    ...
    reset(); // Reset form on close to clear fields
    onClose();
  };
...
// export type TargetFilteringData = z.infer<typeof modalFormSchema>;
...
//   const onSubmit: SubmitHandler<TargetFilteringData> = async (data) => {
//     console.log("Modal form onSubmit triggered with data:", data);
//     try {
//       await onSubmitSuccess(data);
//       console.log("onSubmitSuccess called successfully");
//       onClose();
//     } catch (error) {
