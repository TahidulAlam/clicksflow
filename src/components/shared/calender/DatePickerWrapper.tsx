...
//   onApply?: (date: Date | [Date | null, Date | null]) => void;
//   onCancel?: () => void;
//   monthsShown?: 1 | 2;
...
//         : "";
//     } else if (!isRangeMode && value instanceof Date) {
...
//       {label && <label className="block mb-1 font-bold text-xs">{label}</label>}
//       <input
//         readOnly
...
//       {isOpen && (
//         <div className="absolute z-50 bg-white border border-gray-300 mt-2 rounded shadow-lg">
//           {isRangeMode ? (
//             <DatePicker
//               selectsRange
//               startDate={(tempValue as [Date | null, Date | null])?.[0] || null}
//               endDate={(tempValue as [Date | null, Date | null])?.[1] || null}
//               onChange={(dates) => setTempValue(dates)}
//               inline
//               monthsShown={monthsShown}
//               calendarContainer={({ children }) => (
//                 <div className={monthsShown === 2 ? "flex gap-4 p-2" : ""}>
//                   {children}
//                 </div>
//               )}
//             />
